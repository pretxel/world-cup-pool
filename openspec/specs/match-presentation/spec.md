...
The sticky matchday headers on `/matches` SHALL remain pinned directly below the site navigation, without gap or overlap, at both mobile and desktop viewport widths. The headers act as collapse/expand disclosure controls; making them operable as buttons SHALL NOT change their sticky positioning or offset.
