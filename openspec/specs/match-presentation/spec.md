...
Visual rendering rules for matches across the public list, match detail, and authenticated picks views. Covers country flags, stage iconography, optional venue imagery, and entrance animations. The leaderboard is explicitly outside this capability.
