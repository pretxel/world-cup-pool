...
Rules governing the top-right profile menu shown to authenticated users in the primary navigation. Defines how signed-in users access their identity and account actions from a single avatar-triggered menu, how they sign out, how they edit their display name inline, and the accessibility and localization requirements for the menu.
