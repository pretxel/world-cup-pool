...
Admin-managed catalog of FIFA World Cup 2026 fixtures — kickoff times, group/stage metadata, status, and final scores — exposed as a publicly readable list, with admin CRUD and result entry that drives scoring recomputation.
