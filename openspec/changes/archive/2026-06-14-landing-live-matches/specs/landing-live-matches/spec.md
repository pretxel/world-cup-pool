...
All text introduced by the live fixtures section (heading, "no match on right now" / next-up
copy, and any per-fixture labels) SHALL be provided through the i18n message system for
English, Spanish, and French, with no hardcoded user-facing strings.
