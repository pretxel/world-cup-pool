...
On the My Picks page, the system SHALL display the user's predictions list in pages of at most five picks. The picks SHALL retain their existing order (by match kickoff time, ascending) across pages, so page 1 holds the earliest five, page 2 the next five, and so on.
