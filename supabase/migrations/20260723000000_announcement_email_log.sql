-- ===========================================================================
-- WinScore announcement email — send-once ledger + operation kind
-- ---------------------------------------------------------------------------
-- An admin-triggered, one-off broadcast announces the WinScore rebrand and the
-- newly shipped features (multi-league, crypto payments, and more) to every
-- eligible player. Like winners_email_log there is no date dimension: a player
-- is "pending" while opted-in with NO row here. The row is written only after
-- Resend accepts the message, so the ledger gives at-most-once delivery per
-- player and a failed/partial run leaves the remainder pending for the next run.
--
...
-- posture as public.winners_email_log.
-- ===========================================================================

create table public.announcement_email_log (
...
-- this ledger. Same posture as public.winners_email_log.
